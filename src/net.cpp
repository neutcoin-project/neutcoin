...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Neutcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"neutcointools.com", "138.197.153.223"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"neutcointools.com", "testnet-seed.neutcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Neutcoin is probably already running."), addrBind.ToString().c_str());
        else
